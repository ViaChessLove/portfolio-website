...
export const enSkills: SkillsProps[] = [
  ...
  }, 
  {
    ...
    description: 'And other CSS-in-JS libraries (emoiton)'
  }, 
  {
    id: 10,
...
export const ruSkills: SkillsProps[] = [
  {
    ...
    img: "./assets/images/html.png",
    title: 'HTML',
    description: 'Валидная и адаптивная верстка по шаблонам Figma а также без них.'
  },
  {
    id: 2,
    img: "./assets/images/css.png",
    title: 'CSS',
    description: 'Современный CSS с flex, grid и препроцессорами'
  },
  {
    id: 3,
    img: "./assets/images/js.png",
    title: 'JavaScript',
    description: "ES6+, промисы, генераторы, фетч, опыт работы с API, алгоритмы и анализ сложности"
  },
  {
    id: 4,
    img: "./assets/images/ts.png",
    title: 'TypeScript',
    description: "ООП, строгая типизация"
  },
  {
    id: 5,
    img: "./assets/images/react.png",
    title: 'React',
    description: "React Virtual DOM, хуки, рутинг, опыт разработки SPA, разработка на функциональных компонентах (v16.8)"
  },
  {
    id: 6,
    img: "./assets/images/npm.png",
  ...
  },
  {
    ...
    img: "./assets/images/redux.png",
    title: 'Redux',
    description: 'Обычный Redux, а также его дополнения - Redux-toolkit, saga'
  },
  {
    id: 8,
    img: "./assets/images/scss.png",
    title: 'Sass(SCSS)/LESS',
    description: 'Опыт с препроцессорами CSS - SASS SCSS LESS'
  }, 
  {
    id: 9,
    img: "./assets/images/styled.png",
    title: 'Styled-components',
    description: 'Также был опыт с другими CSS-in-JS вроде emotion'
  }, 
  {
    id: 10,
    img: "./assets/images/mui.png",
    title: 'Material UI',
    description: 'Четвертой версии'
  }, 
  {
    id: 11,
    img: "./assets/images/eslint.png",
    title: 'ESlint',
    description: 'Опыт написания собственных конфигов линтинга ESLint'
  }, 
  {
    id: 12,
    img: "./assets/images/git.png",
    title: 'GIT',
    description: 'Базовые команды для работы с гит (commit, pull, checkout etc.)'
  }
];